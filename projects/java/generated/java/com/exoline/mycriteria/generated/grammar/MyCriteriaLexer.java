...
public class MyCriteriaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IMPORT", "SLASH", "DOT", "COMMA", "SEMICOLON", "SQR_L", "SQR_R", "PAR_L", 
			"PAR_R", "GTE", "LTE", "GT", "LT", "EQUALS", "NOT_EQUALS", "AND", "OR", 
			"TRUE", "FALSE", "EXCL", "NULL_T", "BUCK", "ASSIGN", "OBJECT", "MUL", 
			"ADD", "SUB", "INT", "IDENTIFIER", "STR_LITERAL", "S_Q", "D_Q", "STRING", 
			"WS"
		};
	}
