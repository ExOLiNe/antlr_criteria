...
public:
  enum {
    ...
    INT = 21, STR_LITERAL = 22, STR = 23, NULL_T = 24, WS = 25
  };

  enum {
    RuleExpr = 0, RuleApp = 1, RuleObjectAccessParser = 2
  };
  ...
  class  AndOrContext : public ExprContext {
  public:
    AndOrContext(ExprContext *ctx);
